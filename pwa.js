...
const cacheName = 'LA6SeanLambe-2021-09-29 15:20:46.387647'; // unique value, generated each deploy
const contentToCache = [
  'index.html',
  'code.js',
  'toolbox/bs4/dist/bsFunctions.min.js',
  'toolbox/bs4/dist/css/bootstrap.min.css',
  'toolbox/bs4/dist/css/bootstrap-slider.min.css',
  'toolbox/bs4/dist/js/bootstrap.bundle.min.js',
  'toolbox/bs4/dist/js/bootstrap-slider.min.js',
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'LA6SeanLambe'.length) === 'LA6SeanLambe') {
